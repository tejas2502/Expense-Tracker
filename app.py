...
def expenses():
    ...
    return render_template("expenses.html",expenses=expenses,total=total,t_buisness=t_buisness,t_other=t_other,t_food=t_food,t_entertainment=t_entertainment)
